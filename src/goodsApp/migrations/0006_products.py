# Generated by Django 4.2.7 on 2024-11-11 13:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('goodsApp', '0005_alter_categories_options'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goodsApp.categories', verbose_name='Категория')),
            ],
            options={
